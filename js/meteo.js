...
met.cargarDatos = $(document).ready(function () {
  met.url =
    "https://api.open-meteo.com/v1/forecast?latitude=43.28&longitude=-6.21&daily=weathercode,temperature_2m_max,temperature_2m_min,apparent_temperature_max,apparent_temperature_min,uv_index_max,precipitation_sum,precipitation_probability_max,windspeed_10m_max,winddirection_10m_dominant&timezone=Europe%2FLondon";
